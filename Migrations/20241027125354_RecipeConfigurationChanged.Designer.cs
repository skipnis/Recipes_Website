...
namespace WebCooking.Migrations
{
    ...
    [Migration("20241027125354_RecipeConfigurationChanged")]
    partial class RecipeConfigurationChanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebCooking.Models.RecipeIngredient", b =>
                {
                    ...
                    b.ToTable("RecipeIngredient", null, t =>
                        {
                            t.HasCheckConstraint("Valid_Quantity", "Quantity > 0");
                        });
                });
